...
$path = Get-ChildItem -Path $pshome\PowerShell.exe
$path.CreationTime

Get-ChildItem -Path $pshome\PowerShell.exe | Format-List -Property *
Get-ChildItem -Path $pshome\PowerShell.exe | Select-Object -Property *
